	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-12 col-lg-5 col-xl-4 offset-xl-1 home-nav-content">
				<?php
					$in_button_text = get_field( 'in_button_text' );
					printmeta('in_title', '<h2 class="section-title">%s</h2>');
					printmeta('in_description', '<p>%s</p>');
					printmeta('in_button_url', '<a href="%s" class="button">'.esc_html( $in_button_text ).'</a>');
				?>
			</div><!-- .col -->
			<div class="col-12 col-lg-7 col-xl-6">
				<div class="row home-nav-items">
					<?php if ( have_rows( 'icon_navigation' ) ) : ?>
						<?php 
							while ( have_rows( 'icon_navigation' ) ) :
							the_row(); 
