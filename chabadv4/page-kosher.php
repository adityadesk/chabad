	...
	<main id="primary" class="site-main">
		<div class="page-main">
			<div class="container">
				...
				<?php 
					$foot_cats = get_terms( 'food_categoy', array( 'hide_empty' => false ) );
					if($foot_cats):
				?>
						...
						<?php foreach ($foot_cats as $key => $foot_cat):?>
							...
							?>
								<div class="food-list-items">
									<h2><a href="<?php echo get_term_link( $foot_cat->slug, 'food_categoy' );?>"><?php echo $foot_cat->name;?></h2>
									<div class="row ">
										<?php 
